...
##############################################################################
# mbl_tool.py
#  mbl tool to perform a series of builds from a set of test-manifest*.xml
#  files.
# 
...
# EXAMPLE USAGE
# 
#  Run a test campaign of all the test.xml files in a directory:
...
class mbl_tool:
    ...
    def do_build(self, test_filename_xml, jobs_dir, mbl_manifest_branch):
        ...
        cmd = "cp bblayers.conf " + ws_dir + "/build-mbl/conf"
        ret = app.do_bash(cmd)
        if ret != 0:
